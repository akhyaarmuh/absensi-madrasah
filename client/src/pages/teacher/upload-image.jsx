...
import { uploadProfile, deleteProfile } from '../../fetchers/image';
...
const UploadImage = () => {
  ...
  const handleUploadImage = async (e) => {
    ...
    try {
      ...
      formData.append('model', 'Teacher');
      await uploadProfile(location.state._id, formData);

      if (location.state.from === 'create') navigate('/teacher/create');
  ...
  const handleDeleteImage = async () => {
    ...
    try {
      await deleteProfile(location.state._id, 'Teacher');
      navigate('/teacher');
    } catch (error) {
      console.log(error);
    }
